    ...
    <div id="container">
        ...
        <div id="header">
            ...
            <div id="search-bar-section">
                <div id="search-bar">
                    <form method ="post">
                        <select name="movies" id = "movies" style="height: 30px;width: 400px; margin:30px 30px 10px 0px;">
                  ...
                  <select name="genre" id = "genre"style="height: 30px; width: 250px; margin:30px 30px 10px 20px;">
                   ...
                   <input type="date" name="Date" id="Date"style="height: 30px; width: 200px; margin:30px 30px 10px 10px;">
                        <select name="time" id = "time"style="height: 30px; width: 200px; margin:30px 30px 10px 20px;">
                      ...
                      <input type="reset" value="Search" style="height: 30px; width: 100px; margin:30px 30px 10px 20px;" id="search" onclick="myFunction()"><br>
        ...
        <div id="now-showing-section">
            ...
            <div class="movie-gallery">
                ...
                <div class="movie-card">
                    <img src="./assets/award1.png" alt="Avatar" class="movie-card-poster" style="width:100%" onclick ="document.location.href='movieDetails.php?movie=1'">
