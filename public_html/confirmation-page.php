...
<?php
      ...
      //check if connection to db is possible
        ...
        $a =0;
        echo "<strong><center>Thank you!<br><br>Your booking has been confirmed.<br><br>To collect your ticket, please screenshot this<br> and present it to one of our ticket counters.</center></strong>";
        ...
        echo"<br><center>An acknowledgement receipt has been sent to your e-mail.</center>";
        session_unset();
        session_destroy();
        $db->close();
...
?>
        <div align="center" style="padding-bottom: 10px;">
            <br><br>
        <input class="cart-text" style="padding: 5px 10px;" type="submit" value="Done" ;
